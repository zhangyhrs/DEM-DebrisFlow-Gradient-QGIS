...
Vector result fields are short Chinese field names for practical GIS use: 流域号、面积、沟顶高、沟口高、高差、沟长、纵比降、汇流数.
...
> Use the release package `DEM_DebrisFlow_Gradient_v1.0.1.zip`. GitHub's **Code → Download ZIP** is a source archive and is not the QGIS installation package.
